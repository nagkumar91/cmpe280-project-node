...
def logEntriesGenerator():
	...
	size= [1371,168,58,195,234,235,256,262,327,360,434,485,725,821,931,1088,1134,1280,1594,1595,1742,4024,4676,4677,4703,6375,10095,20221,33632,80605,81649,82865]; 
	...
	space=' '
	logEntry=siteName + space + ipAddr + space + dashes + space + dateTime + space + logRequestMessage+ space+ str(logStatus) + space+ str(logSize) + space+logWebPageAccessed+ space+logMachineInfo+ space
	print(logEntry)		
	return logEntry
